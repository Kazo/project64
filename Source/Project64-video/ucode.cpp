...
{
    {
        ...
        rsp_reserved3, uc6_sprite2d, rdp_invalid, rdp_invalid,
        ...
        rdp_invalid, rdp_invalid, rdp_invalid, rdp_invalid,
        rdp_invalid, rdp_invalid, rdp_invalid, rdp_invalid,
        rdp_invalid, uc0_tri4, rdphalf_cont, rdphalf_2,
    ...
    // games: Mario Kart, Star Fox
    {
        ...
        rdp_invalid, rdp_invalid, rdp_invalid, rdp_invalid,
        rdp_invalid, rdp_invalid, rdp_invalid, rdp_invalid,
        rdp_invalid, rdp_invalid, rdp_invalid, uc6_loaducode,
    ...
    // games: Zelda 64
    {
        ...
        uc2_line3d, uc6_bg_1cyc, uc6_bg_copy, uc6_obj_rendermode/*rdp_invalid*/,
        rdp_invalid, rdp_invalid, rdp_invalid, rdp_invalid,
        ...
        rdp_trifill, rdp_trifillz, rdp_tritxtr, rdp_tritxtrz,
        rdp_trishade, rdp_trishadez, rdp_trishadetxtr, rdp_trishadetxtrz,
        rdp_invalid, rdp_invalid, rdp_invalid, uc2_special3,
    ...
    // ** Added by Gonetz **
    {
        ...
        rdp_invalid, rdp_invalid, rdp_invalid, rdp_invalid,
        rdp_invalid, rdp_invalid, rdp_invalid, rdp_invalid,
        rdp_invalid, uc3_tri2, rdphalf_cont, rdphalf_2,
    ...
    // games: Yoshi's Story
    {
        ...
        rsp_reserved3, rdp_invalid/*uc6_sprite2d*/, rdp_invalid, rdp_invalid,
        rdp_invalid, rdp_invalid, rdp_invalid, rdp_invalid,
        rdp_invalid, rdp_invalid, rdp_invalid, rdp_invalid,
        rdp_invalid, rdp_invalid, rdp_invalid, rdp_invalid,
        rdp_invalid, rdp_invalid, rdp_invalid, rdp_invalid,
        ...
        uc6_ldtx_rect_r, rdp_invalid, rdp_invalid, rdp_invalid,
        rdp_trifill, rdp_trifillz, rdp_tritxtr, rdp_tritxtrz,
        rdp_trishade, rdp_trishadez, rdp_trishadetxtr, rdp_trishadetxtrz,
        rdp_invalid, rdp_invalid, rdp_invalid, rdp_invalid,
        rdp_invalid, rdp_invalid, rdp_invalid, rdp_invalid,
    ...
    // games: Perfect Dark
    {
        ...
        rsp_reserved3, rdp_invalid, rdp_invalid, rdp_invalid,
        rdp_invalid, rdp_invalid, rdp_invalid, rdp_invalid,
        rdp_invalid, rdp_invalid, rdp_invalid, rdp_invalid,
        rdp_invalid, rdp_invalid, rdp_invalid, rdp_invalid,
        rdp_invalid, rdp_invalid, rdp_invalid, rdp_invalid,
...

    {
        ...
        rdp_invalid, rdp_invalid, rdp_invalid, rdp_invalid,
        // 80-bf: Immediate commands
        uc9_object, uc9_rpdcmd, rdp_invalid, rdp_invalid,
        rdp_invalid, rdp_invalid, rdp_invalid, rdp_invalid,
        rdp_invalid, rdp_invalid, rdp_invalid, rdp_invalid,
        rdp_invalid, rdp_invalid, rdp_invalid, rdp_invalid,
        rdp_invalid, rdp_invalid, rdp_invalid, rdp_invalid,
        ...
        rdp_invalid, rdp_invalid, rdp_invalid, rdp_invalid,
        rdp_invalid, rdp_invalid, rdp_invalid, rdp_invalid,
        rdphalf_1, rdp_invalid, uc0_cleargeometrymode, uc0_setgeometrymode,
        uc0_enddl, uc0_setothermode_l, uc0_setothermode_h, uc0_texture,
        uc0_moveword, rdp_invalid, uc0_culldl, rdp_invalid,
        // c0-ff: RDP commands
        rdp_noop, rdp_invalid, rdp_invalid, rdp_invalid,
        rdp_invalid, rdp_invalid, rdp_invalid, rdp_invalid,
        rdp_trifill, rdp_trifillz, rdp_tritxtr, rdp_tritxtrz,
        ...
        uc9_mix, uc9_fmlight, uc9_light, rdp_invalid,
        uc9_mtxtrnsp, uc9_mtxcat, uc9_mult_mpmtx, uc9_link_subdl,
        uc9_set_subdl, uc9_wait_signal, uc9_send_signal, uc0_moveword,
        uc9_movemem, rdp_invalid, uc0_displaylist, uc0_enddl,

        rdp_invalid, rdp_invalid, uc0_setothermode_l, uc0_setothermode_h,
        rdp_texrect, rdp_texrect, rdp_sync_load, rdp_pipesync,
        rdp_tilesync, rdp_fullsync, rdp_setkeygb, rdp_setkeyr,
